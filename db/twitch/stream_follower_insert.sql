create function twitch.stream_follower_insert(channel_ text, follower_ text)
...
BEGIN
    ...
    ON conflict on constraint stream_follower_pk do update set
...
alter function twitch.stream_follower_insert(text, text) owner to markr;
