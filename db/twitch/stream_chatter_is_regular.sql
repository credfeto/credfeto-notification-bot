create function twitch.stream_chatter_is_regular(channel_ text, username_ text)
...
alter function twitch.stream_chatter_is_regular(text, text) owner to markr;

grant execute on function twitch.stream_chatter_is_regular(text, text) to notificationbot;
