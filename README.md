...
1. Create a Twitch Application and authorise it:
...
1. Choose how you want to configure the application:
...
1. Deploy the database to postgres DB. from the files in the `db` folder.
2. Build and run the `Credfeto.Notification.Bot.Server` application. You should see the bot come online in Discord and
