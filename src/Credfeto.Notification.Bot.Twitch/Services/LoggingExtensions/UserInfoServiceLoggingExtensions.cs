...
internal static partial class UserInfoServiceLoggingExtensions
{
    ...
    [LoggerMessage(EventId = 2, Level = LogLevel.Error, Message = "{userName}: Failed to get User information: {message}")]
    public static partial void FailedToGetUserInformation(this ILogger<UserInfoService> logger, Viewer userName, string message, Exception exception);
}