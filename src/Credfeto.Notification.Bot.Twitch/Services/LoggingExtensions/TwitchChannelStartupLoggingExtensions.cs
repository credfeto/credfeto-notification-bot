...
internal static partial class TwitchChannelStartupLoggingExtensions
{
    ...
    [LoggerMessage(EventId = 2, Level = LogLevel.Information, Message = "{streamer}: Found channel {userId}, IsStreamer: {isStreamer}, Date Created: {dateCreated}")]
    public static partial void FoundChannel(this ILogger<TwitchChannelStartup> logger, Streamer streamer, int userId, bool isStreamer, DateTimeOffset dateCreated);
}