...
public sealed class TwitchChannelManager : ITwitchChannelManager
{
    ...
    public TwitchChannelManager(IOptions<TwitchBotOptions> options, ITwitchStreamDataManager twitchStreamDataManager, IMediator mediator, ILogger<TwitchChannelManager> logger)
    {
