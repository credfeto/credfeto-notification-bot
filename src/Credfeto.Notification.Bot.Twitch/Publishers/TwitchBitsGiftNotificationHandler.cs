...
public sealed class TwitchBitsGiftNotificationHandler : INotificationHandler<TwitchBitsGift>
{
    ...
    public async ValueTask Handle(TwitchBitsGift notification, CancellationToken cancellationToken)
    {
        try
        {
            await this._contributionThanks.ThankForBitsAsync(streamer: notification.Streamer,
                                                             user: notification.User,
                                                             bitsGiven: notification.Bits,
