...
public sealed class TwitchCustomMessageHandlerContainsTests : LoggingTestBase
{
    ...
    public TwitchCustomMessageHandlerContainsTests(ITestOutputHelper output)
        : base(output)
    {
            ...
            new TwitchBotOptions
            {
                ...
                [
                    new(
                        ...
                        match: "play",
                        issue: "!play",
                        TwitchMessageMatchType.CONTAINS.GetName()
                    ),
                ],
            }
        );
    ...
    [Fact]
    public async Task ContainsMatchShouldSendWhenCanSendReturnsTrueAsync()
    {
    ...
    [Fact]
    public async Task NonContainsMessageShouldNotMatchAsync()
    {
