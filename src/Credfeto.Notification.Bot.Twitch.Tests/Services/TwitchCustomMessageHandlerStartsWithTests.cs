...
public sealed class TwitchCustomMessageHandlerStartsWithTests : LoggingTestBase
{
    ...
    public TwitchCustomMessageHandlerStartsWithTests(ITestOutputHelper output)
        : base(output)
    {
            ...
            new TwitchBotOptions
            {
                ...
                [
                    new(
                        ...
                        match: "!play",
                        issue: "!play",
                        TwitchMessageMatchType.STARTS_WITH.GetName()
                    ),
                ],
            }
        );
    ...
    [Fact]
    public async Task StartsWithMatchShouldSendWhenCanSendReturnsTrueAsync()
    {
    ...
    [Fact]
    public async Task NonStartsWithMessageShouldNotMatchAsync()
    {
